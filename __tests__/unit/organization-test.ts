...
jest.mock('@/src/server/services/organization-access-control', () => ({
  orgAccess: {
    canAccessOrganization: jest.fn<any>(),
    getUserRole: jest.fn<any>(),
    requirePermission: jest.fn<any>(),
    canUpdateMemberRole: jest.fn<any>(),
  },
}));
  ...
  describe('create', () => {
    it('should create a new organization', async () => {
      ...
      const mockTransaction = jest.fn(async (callback) => {
        const tx = {
          ...
          returning: jest.fn<any>().mockResolvedValue([mockOrganization]),
        };
    ...
    it('should throw error if slug already exists', async () => {
      ...
      (db.select as any).mockReturnValue({
        from: jest.fn<any>().mockReturnThis(),
        where: jest.fn<any>().mockReturnThis(),
        limit: jest.fn<any>().mockResolvedValue([{ slug: 'existing-slug' }]),
      });
  ...
  describe('get', () => {
    it('should return organization details', async () => {
      ...
      (db.select as any).mockReturnValue({
        from: jest.fn<any>().mockReturnThis(),
        where: jest.fn<any>().mockReturnThis(),
        limit: jest.fn<any>().mockResolvedValue([mockOrganization]),
      });
  ...
  describe('getMembers', () => {
    it('should return organization members', async () => {
      ...
      (db.select as any).mockReturnValue({
        ...
        offset: jest.fn<any>().mockResolvedValue(mockMembers),
      });
    ...
    it('should handle existing members', async () => {
      ...
      (db.select as any)
        .mockReturnValueOnce({
          from: jest.fn<any>().mockReturnThis(),
          where: jest.fn<any>().mockReturnThis(),
          limit: jest.fn<any>().mockResolvedValue([{ id: 'existingUser' }]),
        })
        .mockReturnValueOnce({
          from: jest.fn<any>().mockReturnThis(),
          where: jest.fn<any>().mockReturnThis(),
          limit: jest.fn<any>().mockResolvedValue([{ id: 'existingMember' }]),
        });
  ...
  describe('joinByCode', () => {
    ...
    it('should reject expired codes', async () => {
      ...
      (db.select as any).mockReturnValue({
        ...
        innerJoin: jest.fn<any>().mockReturnThis(),
        where: jest.fn<any>().mockReturnThis(),
        limit: jest.fn<any>().mockResolvedValue([mockCode]),
      });
