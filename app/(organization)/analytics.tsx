...
import { AnalyticsBlock } from '@/components/blocks/organization';
...
export default function OrganizationAnalytics() {
  ...
  if (!user || (user.role !== 'admin' && user.role !== 'manager')) {
    log.warn('Non-admin/manager tried to access organization analytics', 'ORG_ANALYTICS', { 
      userId: user?.id, 
      role: user?.role 
    });
  ...
  const handleExport = () => {
    ...
    log.info('Exporting analytics data', 'ORG_ANALYTICS', { organizationId });
  };
