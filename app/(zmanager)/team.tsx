      ...
      <Container size="full" padding="lg">
        <VStack spacing="lg">
          ...
          <HStack justify="between" align="center">
            ...
            <Button
              size="sm"
              onPress={() => router.push('/(zmodals)/invite-member')}
            >
              <UserPlus size={16} />
              <Text>Invite</Text>
            </Button>
                ...
                <HStack spacing="md" align="center">
                  ...
                  <VStack spacing="xs" className="flex-1">
                    <HStack justify="between" align="center">
                      ...
                      <Pressable
                        onPress={() => router.push(`/(zmodals)/member-details?id=${member.id}`)}
                        className="p-2"
                      >
          ...
          <VStack spacing="md">
            <Button 
              ...
              size="lg" 
              className="w-full"
              onPress={() => router.push('/(zmanager)/tasks')}
            >
              <Activity size={20} />
            ...
            <Button 
              ...
              size="lg" 
              className="w-full"
              onPress={() => router.push('/(zmanager)/reports')}
            >
              <TrendingUp size={20} />
