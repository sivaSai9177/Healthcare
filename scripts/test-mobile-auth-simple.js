...
class MobileAuthTester {
  ...
  async runAllTests() {
    ...
    console.log('- Google Cloud Console: Add expo-starter://auth-callback to redirect URIs');
    console.log('- Environment: Set GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET');
    console.log('- Development Build: OAuth does not work in Expo Go');
    console.log('- Network: Ensure mobile device is on same network as dev server');
