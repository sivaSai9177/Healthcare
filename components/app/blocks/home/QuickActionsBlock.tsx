...
export function QuickActionsBlock({ 
  ...
  const defaultActions: QuickAction[] = [
    ...
    },
    {
      ...
      route: '/(zmodals)/notification-center',
      badge: '3',
