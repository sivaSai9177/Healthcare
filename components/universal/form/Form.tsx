...
import { Button, ButtonProps } from '@/components/universal/interaction/Button';
import { VStack, HStack } from '@/components/universal/layout/Stack';
import { Label } from '@/components/universal/typography/Label';
...
export const FormDescription: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <Text size="sm" colorTheme="mutedForeground">{children}</Text>
);

// Export Form with attached components for dot notation usage
