...
export const Table: React.FC<TableProps> = ({
  ...
  }, [animated, shouldAnimate, animationType, animationDelay, duration, opacity, translateY]);
    ...
    >
      <ViewComponent
        style={[
          ...
          animated && shouldAnimate() ? tableAnimatedStyle : {},
        ]}
        entering={Platform.OS !== 'web' && animated && shouldAnimate() && animationType === 'fade'
      ...
      {({ pressed }) => (
        <RowComponent
          className={cn(
            ...
            isStriped && "bg-muted",
            !isStriped && (isHovered || pressed) && "bg-muted",
            !isStriped && !isHovered && !pressed && "bg-transparent"
          )}
          style={style}
        >
          {children}
